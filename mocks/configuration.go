...
type Configuration struct {
	...
	ChildrenStub        func(context.Context) (world.Configurations, error)
	childrenMutex       sync.RWMutex
	childrenArgsForCall []struct {
		arg1 context.Context
	}
	childrenReturns struct {
		result1 world.Configurations
		result2 error
	}
...
func (fake *Configuration) Children(arg1 context.Context) (world.Configurations, error) {
	...
	fake.recordInvocation("Children", []interface{}{arg1})
...
func (fake *Configuration) ChildrenCalls(stub func(context.Context) (world.Configurations, error)) {
	fake.childrenMutex.Lock()
	defer fake.childrenMutex.Unlock()
	fake.ChildrenStub = stub
}

func (fake *Configuration) ChildrenArgsForCall(i int) context.Context {
	fake.childrenMutex.RLock()
	defer fake.childrenMutex.RUnlock()
	argsForCall := fake.childrenArgsForCall[i]
	return argsForCall.arg1
}

func (fake *Configuration) ChildrenReturns(result1 world.Configurations, result2 error) {
	fake.childrenMutex.Lock()
	defer fake.childrenMutex.Unlock()
...
func (fake *Configuration) ChildrenReturnsOnCall(i int, result1 world.Configurations, result2 error) {
	fake.childrenMutex.Lock()
	defer fake.childrenMutex.Unlock()
	fake.ChildrenStub = nil
