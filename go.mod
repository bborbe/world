...
require (
	...
	github.com/bborbe/run v0.0.0-20190723085027-d2ca2c9a7ee0
	github.com/bborbe/teamvault-utils v0.0.0-20200101152120-5357a2c26f65
	...
	golang.org/x/tools v0.0.0-20200406165137-ee2abff5cfa7 // indirect
